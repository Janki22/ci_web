								...
								<?php foreach ($articles as $article) { ?>
									<tr>
										...
										<td>
											...
											<?php } else { ?>
												<img class="w-100" width="314" src="<?php echo base_url() . 'public/uploads/no_image.jpg'; ?>" />
											<?php } ?>
										</td>
										...
										<td>
											<a href="<?php echo base_url() . 'admin/article/edit/' . $article['id']; ?>" class="btn btn-primary btn-sm"> <i class="far fa-edit"></i></a>
...
<script>
	function deleteArticle(id) {
		...
		//    alert('<?php echo base_url() . 'admin/articles/delete/'; ?>'+id);
	}
</script>
