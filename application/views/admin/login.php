...
<body class="hold-transition login-page" style="background-color: #44827d;">
<div class="login-box">
  <div class="login-logo">
    <a href="#" style="color: #fff;"><b >CI</b> Web Application</a>
  </div>
  <!-- /.login-logo -->
  <?php
  ...
  ?>
  <div class="card">
    <div class="card-body login-card-body" style="background-color: #69c9c1;">
      <p class="login-box-msg">Sign in to start your session</p>

      <form action="<?php echo base_url().'index.php/admin/login/authenticate'?>" name="loginForm" id="loginForm" method="post">
