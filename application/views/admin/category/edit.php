   ...
   <div class="container-fluid">
	 <div class="row">
	   <div class="col-lg-12">
		...
		<form name="categoryForm" id="categoryForm" enctype="multipart/form-data" method="post" action="<?php echo base_url().'admin/category/edit/'.$category['id'] ?>">
		...
		<label for="">Image</label><br>
         ...
         <?php  if ($category['image'] != "" && file_exists('./public/uploads/category/thumb/'.$category['image'])) { ?>
          <img class="mt-3" src="<?php  echo base_url().'public/uploads/category/thumb/'.$category['image'] ?>" alt="">
			<?php }  else {?>
				<img width="300" src="<?php  echo base_url().'public/uploads/category/no_image.jpg'; ?>" alt="">
	 ...
	 <div class="card-footer">
		...
		<a href="<?php echo base_url().'admin/category/index'; ?>" class="btn btn-secondary">Black</a>
	 </div>
	 </div><!---card-body-->
		 </form>  	  
	   </div>
